...
import ModalPermanentHiring from "../UiElements/ModalPermanentHiring"

const ContactFormPayment = ({ data }) => {
  ...
  if (mustReadTerms) {
    allFieldsSet =
      allFieldsSet && formData.termsAgree !== undefined ? true : false
  }
        ...
        <form onSubmit={e => handleOnSubmit(e)}>
          ...
          <fieldset>
            ...
            <div className="submitButton">
              <button disabled={!allFieldsSet} type="submit">
                Submit
              </button>
            </div>
          </fieldset>
...
export default ContactFormPayment
